      ...
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.title,
                      style: GoogleFontStyles.h6(color: Colors.white),
                      maxLines: 2,
                    ...
                    Text(
                      widget.time,
                      style: GoogleFontStyles.h6(color: Colors.grey[400]),
                    ),
                  ],
                ),
              ),
          ...
          if (widget.notificationItems.status != null &&
              widget.notificationItems.status!.contains('mark_as_done'))
            Row(
              children: [
                Padding(
                  ...
                  child: Obx(
                    () => CustomButton(
                      ...
                      onTap: () async {
                        ...
                        if (widget.notificationItems.bookingId != null) {
                          await bookingMngCtrl.confirmOrDeclineOrder(
                            bookingGroupId: widget.notificationItems.bookingId,
                            status: 'completed',
                            index: widget.index,
                            callback: () {
                              setState(() {
                                widget.notificationItems.status = 'completed';
                              });
                            },
                          );
                        }
                ...
                Padding(
                  ...
                  child: Obx(
                    () => CustomButton(
                      ...
                      color: Colors.red,
                      loading:
                      bookingMngCtrl.isLoadingCancel[widget.index] ?? false,
                      onTap: () async {
                        print(widget.notificationItems);
                        if (widget.notificationItems.bookingId != null) {
                          await bookingMngCtrl.confirmOrDeclineOrder(
                            ...
                            callback: () {
                              setState(() {
                                widget.notificationItems.status = 'cancel';
                              });
                            },
                          );
                        }
          ...
          else if (widget.notificationItems.status != null && widget.notificationItems.status!.contains('completed') || widget.notificationItems.status!.contains('cancel'))
             Align(
              ...
              child: Container(
                ...
                child: Text(widget.notificationItems.status!.contains('completed') ?'Order Completed': 'Order Cancelled'),
              ),
            ),
        ],
      ),
